...
class Bank():
    ...
    def closeAccount(self):
        ...
        if theBalance is not None:
            ...
            del self.accountsDict[userAccountNumber] # Remove account
...
'''
Two methods used to create an account:

1. The openAccount() method asks the user questions to obtain information

2. The createAccount() method instantiates a new account


openAccount() calls creatAccount()

createAccount() instantiates an Account object, and returns an account number to openAccount()

openAccount() returns that account number back to the user
